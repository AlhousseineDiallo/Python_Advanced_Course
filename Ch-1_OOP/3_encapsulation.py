...
print(
    obj._dyn3
)  # It will print "xyz" because _dyn3 is a protected variable and it can be accessed outside the class but it is not recommended to do so. It is just a convention to use _ before the variable name to indicate that it is a protected variable and it should not be accessed outside the class.
